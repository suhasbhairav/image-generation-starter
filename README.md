...
`AI templates` · `AI starter template` · `Next.js AI templates` · `nextjs ai templates` · `OpenAI templates` · `open ai templates` · `Image Generation Starter` · `Image Generation Template` · `open-source AI template` · `free AI template` · `Next.js AI template`
...
| Route | Purpose |
| --- | --- |
| `/api/generate-image` | Runs the image generation workflow from the server. |
...
- [This Template Page](https://suhasbhairav.com/ai-templates/image-generation-starter)
